...
public class ShoppingFrame extends JFrame {
    ...
    // adds a product to the panel, including a textfield for user input of the quantity
    ...
    // When the user types a new value into one of the quantity fields, parse the input and update the ShoppingCart.  
    // Display an error message if text is not a number or is negative.
